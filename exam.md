...
**2.**
Добавим пользователя exam и разрешим ему sudo без пароля,также добавим его в 2 группы - адм(просмотр всех журналов) и группу wheel (из которой можно переходить в root ):
